...
#endregion
#region Design
// Samples are also in timewarp-mediator.slnx, so `dev build` already compiles
// them. This command rebuilds each samples/**/*.csproj so the required
// verify-samples capability is a real gate, not a stub.
#endregion
